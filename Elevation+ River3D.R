...
rayshader::render_highquality(
  light = TRUE,  # Add lighting effects for realism
  filename = "3D_map_render.png",  # Save to file
  interactive = FALSE,  # Set to false if you don't need interactive rendering
  width = 2000, 
  height = 2000, 
  environment_light = hdri_file,
  intensity_env = 1  # Adjust environment light intensity
)
